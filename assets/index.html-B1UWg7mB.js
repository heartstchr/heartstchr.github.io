...
`)},ze={root:function(n){var t=n.props;return["p-timeline p-component","p-timeline-"+t.align,"p-timeline-"+t.layout]},event:"p-timeline-event",eventOpposite:"p-timeline-event-opposite",eventSeparator:"p-timeline-event-separator",eventMarker:"p-timeline-event-marker",eventConnector:"p-timeline-event-connector",eventContent:"p-timeline-event-content"},Ke=T.extend({name:"timeline",theme:Ue,classes:ze}),He={name:"BaseTimeline",extends:P,props:{value:null,align:{mode:String,default:"left"},layout:{mode:String,default:"vertical"},dataKey:null},style:Ke,provide:function(){return{$pcTimeline:this,$parentInstance:this}}},ne={name:"Timeline",extends:He,inheritAttrs:!1,methods:{getKey:function(n,t){return this.dataKey?pe(n,this.dataKey):t},getPTOptions:function(n,t){return this.ptm(n,{context:{index:t,count:this.value.length}})}}};function Fe(e,n,t,a,r,i){return l(),h("div",s({class:e.cx("root")},e.ptmi("root")),[(l(!0),h(A,null,_(e.value,function(f,d){return l(),h("div",s({key:i.getKey(f,d),class:e.cx("event"),ref_for:!0},i.getPTOptions("event",d)),[o("div",s({class:e.cx("eventOpposite",{index:d}),ref_for:!0},i.getPTOptions("eventOpposite",d)),[m(e.$slots,"opposite",{item:f,index:d})],16),o("div",s({class:e.cx("eventSeparator"),ref_for:!0},i.getPTOptions("eventSeparator",d)),[m(e.$slots,"marker",{item:f,index:d},function(){return[o("div",s({class:e.cx("eventMarker"),ref_for:!0},i.getPTOptions("eventMarker",d)),null,16)]}),d!==e.value.length-1?m(e.$slots,"connector",{key:0,item:f,index:d},function(){return[o("div",s({class:e.cx("eventConnector"),ref_for:!0},i.getPTOptions("eventConnector",d)),null,16)]}):y("",!0)],16),o("div",s({class:e.cx("eventContent"),ref_for:!0},i.getPTOptions("eventContent",d)),[m(e.$slots,"content",{item:f,index:d})],16)],16)}),128))],16)}ne.render=Fe;var Je=T.extend({name:"accordiontab"}),Re={name:"BaseAccordionTab",extends:P,props:{header:null,headerStyle:null,headerClass:null,headerProps:null,headerActionProps:null,contentStyle:null,contentClass:null,contentProps:null,disabled:Boolean},style:Je,provide:function(){return{$pcAccordionTab:this,$parentInstance:this}}},ie={name:"AccordionTab",extends:Re,inheritAttrs:!1,mounted:function(){console.warn("Deprecated since v4. Use the new structure of Accordion instead.")}};function Ge(e,n,t,a,r,i){return m(e.$slots,"default")}ie.render=Ge;var We=function(n){var t=n.dt;return`
.p-carousel {
    display: flex;
    flex-direction: column;
}
