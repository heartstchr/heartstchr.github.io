...
<section class="hero-newage relative overflow-hidden px-4 md:px-8 lg:px-12 surface-0 flex align-items-center" style="min-height: 100vh;">
  ...
  <div class="grid align-items-center relative z-1 w-full max-w-screen-xl mx-auto py-4">
    <div class="col-12 lg:col-7">
      ...
      <h1 class="m-0 p-0 line-height-1 text-6xl md:text-6xl lg:text-7xl font-bold tracking-tight">
...
<div class="mb-8 py-8 md:py-12 surface-50 border-round-3xl relative overflow-hidden" style="max-width: 1300px; margin: 0 auto;">
  ...
  <div class="grid relative z-1">
    <div class="col-12 md:col-6 p-3">
      <div class="glass-effect-light p-4 border-round-3xl h-full">
        <div class="bg-green-100 text-green-600 border-circle w-4rem h-4rem flex align-items-center justify-content-center mb-4"><i class="pi pi-sparkles text-2xl"></i></div>
    ...
    <div class="col-12 md:col-6 p-3">
      <div class="glass-effect-light p-4 border-round-3xl h-full flex flex-column">
        <div class="bg-purple-100 text-purple-600 border-circle w-4rem h-4rem flex align-items-center justify-content-center mb-4"><i class="pi pi-code text-2xl"></i></div>
    ...
    <div class="col-12 md:col-6 p-3">
      <div class="glass-effect-light p-4 border-round-3xl h-full">
        <div class="bg-orange-100 text-orange-600 border-circle w-4rem h-4rem flex align-items-center justify-content-center mb-4">
        <i class="pi pi-users text-2xl"></i></div>
    ...
    <div class="col-12 md:col-6 p-3">
      <div class="glass-effect-light p-4 border-round-3xl h-full">
        <div class="bg-blue-100 text-blue-600 border-circle w-4rem h-4rem flex align-items-center justify-content-center mb-4"><i class="pi pi-database text-2xl"></i></div>
...
<div id="solutions" class="mb-8">
  ...
  <!-- Pillar 1 -->
  <div class="grid align-items-center mb-8 p-4 border-round-3xl border-1 border-white-alpha-10 relative">
    ...
    <div class="col-12 lg:col-5 relative z-1">
      ...
      <ul class="list-none p-0 m-0 mb-2 text-700">
    ...
    <div class="col-12 lg:col-7 relative z-1">
      <div class="grid">
        <div class="col-12 p-4">
          <a href="/web-development-projects/ai-dynamic-crud-app/" class="block bento-hover relative border-round-3xl overflow-hidden  no-underline border-1 border-white-alpha-10">
        ...
        <div class="col-12 p-4">
          <a href="/web-development-projects/ai-voice-generator/" class="block bento-hover relative border-round-3xl overflow-hidden  no-underline border-1 border-white-alpha-10">
  ...
  <!-- Pillar 2 -->
  <div class="grid align-items-center mb-8 p-4 border-round-3xl border-1 border-white-alpha-10 relative flex-column lg:flex-row-reverse">
    <div class="absolute top-0 right-0 p-4 opacity-10">
    ...
    <div class="col-12 lg:col-7 relative z-1">
      <div class="grid">
        <div class="col-12 p-4">
          <a href="/web-development-projects/ibrebuild-for-abn-amro-bank-n-v/" class="block bento-hover relative border-round-3xl overflow-hidden  no-underline border-1 border-white-alpha-10">
  ...
  <div class="grid align-items-center mb-8 p-4 border-round-3xl border-1 border-white-alpha-10 relative">
    ...
    <div class="col-12 lg:col-7 relative z-1">
      <div class="grid">
        <div class="col-12 p-4">
          <a href="/web-development-projects/local-home-services-pros/" class="block bento-hover relative border-round-3xl overflow-hidden  no-underline border-1 border-white-alpha-10">
        ...
        <div class="col-12 p-4">
          <a href="/web-development-projects/appliance-repair-service-platform/" class="block bento-hover relative border-round-3xl overflow-hidden  no-underline border-1 border-white-alpha-10">
...
<div class="mb-8 text-center" id="pricing">
  ...
  <div class="grid justify-content-center">
    ...
    <div class="col-12 lg:col-3 md:col-6 p-2">
      <div class="surface-0 border-round-2xl  p-4 h-full flex flex-column text-left relative overflow-hidden border-2 border-primary">
    ...
    <div class="col-12 lg:col-3 md:col-6 p-2">
      <div class="surface-0 border-round-2xl shadow-2 p-4 h-full flex flex-column text-left hover:shadow-4 transition-all border-1 border-200">
...
<div class="mb-8 py-4">
  ...
  <div class="grid" style="max-width: 1240px; margin: 0 auto;">
    <div class="col-12 lg:col-4 p-3" v-for="slot in testimonials" :key="slot.name">
      <div class="border-round-2xl p-4 h-full flex flex-column border-1 border-100 bento-hover">
...
<!-- Contact CTA -->
<div class="mb-8 border-round-3xl p-4 text-center surface-section relative overflow-hidden" style="max-width: 1000px; margin: 0 0;">
