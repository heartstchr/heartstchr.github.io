...
1.  **Proprietary Wrappers:** Using "internal frameworks" that no developer on the open market has ever seen.
2.  **Zero Documentation:** Writing "clever" code that is impossible for a new engineer to read without months of study.
3.  **Restricted Access:** Keeping the source code in their private repositories and only giving you a "finished" build.
