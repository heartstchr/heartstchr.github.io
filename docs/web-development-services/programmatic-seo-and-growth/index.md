...
description: "I build high-velocity programmatic SEO platforms that dominate search rankings. Using database-driven routing to generate thousands of optimized landing pages that capture long-tail local traffic."
lastUpdated: false
editLink: false
contributors: false
pageInfo: false
...
service:
  ...
  description: "I build high-velocity programmatic SEO platforms that dominate search rankings. Using database-driven routing to generate thousands of optimized landing pages that capture long-tail local traffic."
  benefits: ["Search architecture for scalable location and category pages","Fast page-generation system with templates, data, and internal linking","Lead capture flows tied directly to commercial search intent"]
  outcomes: ["Manual content workflows that cannot scale to thousands of landing pages","Slow sites that waste long-tail demand and fail to index well","SEO content disconnected from conversion and lead capture"]
...
<section class="mt-4 mb-6">
  <div class="grid align-items-center">
    <div class="col-12 lg:col-7">
      ...
      <h1 class="text-4xl md:text-6xl font-bold mb-3 mt-0 line-height-2">Programmatic Growth Engines</h1>
      <p class="text-xl opacity-70 line-height-4 max-w-40rem mb-4">I build high-velocity programmatic SEO platforms that dominate search rankings. Using database-driven routing to generate thousands of optimized landing pages that capture long-tail local traffic.</p>
