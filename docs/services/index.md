...
<!-- Contact Me -->
<div class="my-6 border-round-md vp-feature-item" id="contact">
  ...
  <div>
    ...
    <div class="my-4">
      <a href="mailto:jiwan.cse@gmail.com?subject=Inquiry%20fro%20the%20services" size="large" color="deeppink" class="flex justify-content-center text-center no-underline"> 
