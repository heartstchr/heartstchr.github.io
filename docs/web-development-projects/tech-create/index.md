...
project:
  ...
  perspective: {"executive":"A high-converting marketing site for a digital solutions studio — fast, on-brand, and measurable. Built to turn visitors into project inquiries rather than just traffic.","technical":"Vue.js + PrimeVue landing page deployed on Vercel, with componentized sections, fast global delivery, and conversion-focused layout and copy hierarchy."}
