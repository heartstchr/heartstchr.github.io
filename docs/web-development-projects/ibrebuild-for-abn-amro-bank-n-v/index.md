...
description: "ABN AMRO's internet banking application rebuilt from AngularJS to Vue.js — a zero-downtime modernization of a mission-critical banking platform."
lastUpdated: false
editLink: false
contributors: false
pageInfo: false
...
project:
  ...
  description: "IBRebuild modernized ABN AMRO Bank's internet banking application, migrating it from an aging AngularJS codebase to Vue.js. The rebuild delivered a faster, component-driven UI while the legacy system kept running until the new frontend was proven in production."
  software: "Web"
