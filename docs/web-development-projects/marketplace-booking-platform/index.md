...
project:
  ...
  perspective: {"executive":"A multi-vendor marketplace where supply meets booking demand: listings, availability, and transactions in one coherent product that a small team can launch and a larger team can extend.","technical":"Vendor/product data model with booking lifecycle, search and listing views, and a transaction layer that keeps quote, hold, and confirmation states consistent."}
