...
project:
  ...
  perspective: {"executive":"An embeddable contact form widget that forwards submissions straight to a Notion database — making lead capture and CRM sync one step instead of two for any website owner.","technical":"Generator-based component allowing multiple form configurations per integration, posting structured submissions to Notion; embeddable as a plain script tag with no host-page dependency."}
